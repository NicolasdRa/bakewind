...
export const recipes = pgTable(
  'recipes',
  {
    ...
    // Tenant reference - which bakery owns this recipe
  ...
  (table) => ({
    ...
    idxRecipeTenantCategory: index('idx_recipe_tenant_category').on(
      table.tenantId,
      table.category,
    ),
    idxRecipeTenantActive: index('idx_recipe_tenant_active').on(
      table.tenantId,
      table.isActive,
    ),
  }),
