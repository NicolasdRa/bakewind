...
export async function seedRecipes(db: NodePgDatabase<typeof schema>) {
  ...
  // Check existing recipes to prevent duplicates (per-tenant)
  ...
  const recipesToSeed = [
    ...
    },
    {
      ...
      category: 'cake',
      description:
        'Festive vanilla layer cake with buttercream frosting, perfect for celebrations',
      prepTime: 45,
      cookTime: 35,
      yield: 1,
      yieldUnit: '9-inch cake',
      ...
      sellingPrice: '48.00',
      instructions: [
        'Preheat oven to 175°C and prepare cake pans',
        'Cream butter and sugar until light and fluffy',
    ...
    },
    {
      ...
      category: 'pastry',
      description:
        'Moist muffins bursting with fresh blueberries and streusel topping',
      prepTime: 20,
      cookTime: 22,
      yield: 12,
      yieldUnit: 'muffins',
    ...
    },
    {
      ...
      category: 'bread',
      description:
        'Moist banana bread with optional chocolate chips or walnuts',
      prepTime: 15,
      cookTime: 60,
      yield: 1,
      yieldUnit: 'loaf',
    ...
    },
    {
      ...
      category: 'pastry',
      description:
        'Classic double-crust apple pie with cinnamon and brown sugar',
      prepTime: 60,
      cookTime: 55,
      yield: 8,
      yieldUnit: 'slices',
    ...
    },
    {
      ...
      category: 'pastry',
      description:
        'Choux pastry filled with vanilla cream and topped with chocolate',
      prepTime: 90,
      cookTime: 35,
      yield: 12,
      yieldUnit: 'eclairs',
    ...
    // ========== ADDITIONAL BREAD RECIPES ==========
    {
      ...
      category: 'bread',
      description:
        'Italian white bread with a soft, porous interior and crispy crust',
      prepTime: 240,
      cookTime: 30,
      yield: 2,
      yieldUnit: 'loaves',
      ...
      instructions: [
        ...
        'Bake at 220°C for 30 minutes with steam',
      ],
      nutritionalInfo: {
        calories: 220,
        protein: 7,
    ...
    },
    {
      ...
      instructions: [
        ...
        'Shape into loaf pan',
        'Second rise for 1 hour',
        'Egg wash and bake at 180°C for 35 minutes',
      ],
      nutritionalInfo: {
        calories: 310,
        protein: 8,
    ...
    // ========== ADDITIONAL PASTRY RECIPES ==========
    {
      ...
      category: 'pastry',
      description:
        'Butter croissant filled with almond cream and topped with sliced almonds',
      prepTime: 120,
      cookTime: 15,
      yield: 8,
    ...
    },
    {
      ...
      category: 'cookie',
      description:
        'Soft and chewy peanut butter cookies with signature fork marks',
      prepTime: 15,
      cookTime: 12,
      yield: 24,
      yieldUnit: 'cookies',
    ...
    },
    {
      ...
      category: 'cookie',
      description:
        'Soft cinnamon-sugar cookies with a tangy cream of tartar flavor',
      prepTime: 20,
      cookTime: 10,
      yield: 30,
      yieldUnit: 'cookies',
    ...
    },
    {
      ...
      category: 'cookie',
      description:
        'Delicate French almond meringue cookies with various fillings',
      prepTime: 90,
      cookTime: 15,
      yield: 24,
      yieldUnit: 'macarons',
    ...
    },
    {
      ...
      category: 'sandwich',
      description:
        'Italian-style sandwich with fresh mozzarella, tomato, and basil',
      prepTime: 8,
      cookTime: 0,
      yield: 1,
      yieldUnit: 'sandwich',
  ...
  const newRecipes = recipesToSeed.filter(
    (recipe) => !existingRecipeNames.has(recipe.name),
  );

  if (newRecipes.length === 0) {
    console.log('⚠️  All recipes already exist, skipping insertion');
    // Fetch all recipes to use for ingredients
    const recipeList = await db.select().from(recipes);
    console.log(`✅ Using ${recipeList.length} existing recipes`);
  ...
  const validIngredients = ingredientsData.filter(
    (ing): ing is typeof ing & { ingredientId: string } =>
